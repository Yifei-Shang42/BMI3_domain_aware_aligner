...
def domain_aware_greedy_MSA(all_domains, id_seq_dict, sigma=11, epsilon=1):
    ...
    def calculate_distance_matrix(curr_split_seqs, sigma, epsilon):
        """
    ...
    def merge_sequences(trace, curr_align):
        ...
        print(alignment1_new)
        print(alignment2_new)
    ...
    for structure_identifier in categories:
        ...
        D_dict = calculate_distance_matrix(curr_split_seqs, sigma, epsilon)
        print(D_dict)
        ...
        for trace in traces:
            curr_align = merge_sequences(trace, curr_align)
